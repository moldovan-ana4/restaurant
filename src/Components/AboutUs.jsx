      ...
      <div className={styles.about__container}>
        ...
        <div>
          ...
          <p>
            ...
            but often limited because of the hours spent in the kitchen.
          </p>
          <p>
            Resto. set out to change something in this regard. We offer you top
            quality products, made with freshly kneaded dough and fresh
          ...
          <div className={styles.about__details}>
            ...
            <div className={styles.about__options}>
              <span className={styles.about__icons}>{<FaWalking />}</span>
